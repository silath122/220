...
class Face:
    def __init__(self, window, center, size):
        self.shock_mouth = None
        self.happy_mouth = None
        eye_size = 0.15 * size
        eye_off = size / 3.0
        mouth_size = 0.8 * size
        mouth_off = size / 2.0
    ...
    def smile(self, window, center, size):
        ...
        point_3.move(0, mouth_off - 1)
        self.happy_mouth = Polygon(point_1, point_2, point_3)
        self.happy_mouth.draw(window)
    ...
    def shock(self, window, center, size):
        ...
        self.left_eye.draw(window)
        self.right_eye.draw(window)
        self.shock_mouth = Circle(center, eye_size)
        self.shock_mouth.move(0, eye_size / 3)
